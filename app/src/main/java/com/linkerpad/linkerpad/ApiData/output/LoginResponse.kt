...
data class userInformationResponseLogin(var firstName: String, var lastName: String, var profilePicture: String, var emailAddress: String, var mobileNumber: String, var company: String)